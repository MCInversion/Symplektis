...
namespace Symplektis::GeometryKernel
{
    ...
    public:
        ...
        void SetTransformation(const GeometryKernel::Matrix4& matrix)
        {
            TransformationMatrix = matrix;
        }

        BasePolygonalGeometryData  BaseGeometryData;
        GeometryKernel::Matrix4      TransformationMatrix;
    };
    ...
    public:
        ...
        */
        //-----------------------------------------------------------------------------
        ReferencedMeshGeometry(const BasePolygonalGeometryData& geometryData, const GeometryKernel::Matrix4& transformationMatrix);
        ...
        */
         ...
         */
         //-----------------------------------------------------------------------------
        [[nodiscard]] const GeometryKernel::Matrix4& GetTransformationMatrix() const
        {
         ...
         */
         //-----------------------------------------------------------------------------
        GeometryKernel::Matrix4& GetTransformationMatrix()
        {
            return GetPImpl().TransformationMatrix;
        }
