...
* =======================================================================================================
* In our case:
*	- Forward declaration is not needed since these enums are only included once for every class in Symplekt_GeometryKernel
*	- Names are designed within Symplektis::GeometryKernel namespace so that they do not class
* 
