...
namespace Symplektis::GeometryKernel
{
	...
	Quaternion& Quaternion::SetFromAxisAngle(const Vector3& axis, double angle)
	{
		...
		{
			MSG_CHECK(false, "Symplektis::GeometryKernel::Quaternion::SetFromAxisAngle: rotation axis is not normalized!\n");
			return *this;
		}
	...
	Quaternion& Quaternion::Normalize()
	{
		if (IsZero())
		{
			MSG_CHECK(false, "Symplektis::GeometryKernel::Quaternion::SetFromAxisAngle: attempting to normalize a zero quaternion!\n");
			return *this;
		}
